...
const EN: Record<TranslationKey, string> = {
  ...
  landing_subtitle: 'Shows handpicked by professional, content for every age bracket and for the family. Totally safe',
  ...
  what_we_offer_subtitle:
    'We offer shows that are safe for kids of various age groups. We also offer a wide variety of shows that are educational and fun for kids.',
  what_we_offer_card1_title: 'Curated content',
  what_we_offer_card1_subtitle:
    'Our programs ranges from educational, animated and entertaining content. All carefully seleced',
  what_we_offer_card2_title: 'Parental Control',
  what_we_offer_card2_subtitle:
    'Kids stream have give maximum access to parent or guardian to cutomize content to kids preference.',
  ...
  what_we_offer_sign_up_subtitle:
    'The perfect place for family bonding and learning. The pioritize the wellbeing of every child.',
  ...
  payment_plan_yearly_subtitle:
    'Our yearly subcription option allow you to have access to all our amazing features, all year round',
...
const DE: Record<TranslationKey, string> = {
  ...
  landing_subtitle:
    'Von Fachleuten handverlesene Sendungen, Inhalte für jede Altersgruppe und für die ganze Familie. Völlig sicher',
  ...
  what_we_offer_subtitle:
    'Wir bieten Sendungen, die für Kinder verschiedener Altersgruppen sicher sind. Wir bieten auch eine große Auswahl an Sendungen, die für Kinder lehrreich und unterhaltsam sind.',
  what_we_offer_card1_title: 'Kuratierte Inhalte',
  what_we_offer_card1_subtitle:
    'Unsere Programme reichen von lehrreichen, animierten und unterhaltsamen Inhalten. Alle sorgfältig ausgewählt',
  what_we_offer_card2_title: 'Kindersicherung',
  what_we_offer_card2_subtitle:
    'Kids stream haben Eltern oder Erziehungsberechtigten maximalen Zugriff, um Inhalte an die Vorlieben der Kinder anzupassen.',
  ...
  what_we_offer_sign_up_subtitle:
    'Der perfekte Ort für Familienbindung und Lernen. Die Priorität liegt auf dem Wohlergehen jedes Kindes.',
  ...
  payment_plan_monthly_subtitle:
    'Abonnieren Sie monatlich, um ohne Einschränkungen auf alle unsere erstaunlichen Funktionen zugreifen zu können',
  payment_plan_yearly_title: 'Jährliches Abonnement bezahlen',
  payment_plan_yearly_subtitle:
    'Unsere jährliche Abonnementoption ermöglicht es Ihnen, das ganze Jahr über auf alle unsere erstaunlichen Funktionen zuzugreifen',
  footer_title: 'Kids Stream Services',
