...
const LandingPage = () => {
  ...
  <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 px-6">
    <div className="flex h-full">
      <PlainCard icon={curatedContentIcon} title={t('what_we_offer_card1_title')} description={t('what_we_offer_card1_subtitle')} />
    </div>
  </div>
  <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 px-6 mt-5 sm:mt-0">
    <div className="flex h-full">
      <PlainCard icon={parentalControlIcon} title={t('what_we_offer_card2_title')} description={t('what_we_offer_card2_subtitle')} />
    </div>
  </div>
  <div className="w-full sm:w-1/2 md:w-1/2 lg:w-1/3 px-6 mt-5 lg:mt-0 md:mr-auto">
    <div className="flex h-full">
      <PlainCard icon={easyToUseIcon} title={t('what_we_offer_card3_title')} description={t('what_we_offer_card3_subtitle')} />
    </div>
  </div>
        </div>
  ...
  <div className="w-full sm:w-4/12">
    <div className="flex flex-col items-start text-left">
      ...
      <LayoutPanel fullWidth>
       <Title variant="h2" className="text-center mb-8">{t("program_list_title")}</Title>
    <div className="flex gap-4 -ml-24 flex-grow mb-12">
      <PlainCard icon={sliderImg1} plain={true}/>
      <PlainCard icon={sliderImg2} plain={true}/>
      <PlainCard icon={sliderImg3} plain={true}/>
      <PlainCard icon={sliderImg4} plain={true}/>
    </div>
    <div className="flex gap-4 -mr-24 flex-grow ">
      ...
      <LayoutPanel>
        <Title variant="h2" className="text-center mb-4">{t("platform_title")}</Title>
       <Text variant="title" className="text-center text-xl mb-12">{t("platform_subtitle")}</Text>
<div>
...
<img src={phoneIcon} alt="" />
      ...
      <LayoutPanel fullWidth>
        <div className="px-28">
          <Title  variant="h2" className="text-center mb-4">{t("payment_plan_title")}</Title>
          <Text variant="title" className="text-center text-xl mb-12">{t("payment_plan_subtitle")}</Text>
        <div className="flex flex-col md:flex-row justify-between items-center mb-5">
        <div className="w-75 md:w-50">
          <Title variant="h4">{t("payment_plan_monthly_title")}</Title>
          <Text variant="title" className="text-xl mb-12">{t("payment_plan_monthly_subtitle")}</Text>
        </div>
        <div>
        ...
        <div className="w-75 md:w-50">
          ...
          <Text variant="title" className="text-xl mb-12">{t("payment_plan_yearly_subtitle")}</Text>
        </div>
        </div>
        </div>
