...
function PlainCard({ icon, title, description, plain }: Iprops) {
  return !plain ? (
    <div
      className="h-full p-6 bg-[#F6FAFD] w-full"
      style={{
    ...
    <Card className="max-w-[32rem] overflow-hidden">
      <CardHeader floated={false} shadow={false} color="transparent" className="m-0 rounded-none max-w-full">
        <img
          src={icon}
          alt="review check"
